...
const plans = [
  {
    ...
    perMonth: "9,90",
    discount: "50% OFF",
    link: "https://pay.kirvano.com/d30709d0-7b09-421b-9b19-e2e568ad1259",
    popular: false,
    icon: Zap,
  },
  {
    ...
    perMonth: "4,65",
    discount: "53% OFF",
    link: "https://pay.kirvano.com/38f4e4d1-ed88-4552-8302-1e497ffa8936",
    popular: true,
    icon: Crown,
  },
  {
    ...
    perMonth: "6,30",
    discount: "36% OFF",
    link: "https://pay.kirvano.com/60cdf84c-c2bf-4b94-acfc-f4e235c16202",
    popular: false,
    icon: Star,
  },
];
